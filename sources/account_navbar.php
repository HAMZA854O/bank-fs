        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            ...
            <li class="nav-item d-flex align-items-center">
              <a href="<?php echo filter_var($settings['url']); ?>account/activity" class="nav-link text-body font-weight-bold px-0">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <li class="nav-item d-flex align-items-center">
              <a href="<?php echo filter_var($settings['url']); ?>account/disputes" class="nav-link text-body font-weight-bold px-0">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <li class="nav-item d-flex align-items-center">
              <a href="<?php echo filter_var($settings['url']); ?>account/supports" class="nav-link text-body font-weight-bold px-0">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <li class="nav-item d-flex align-items-center">
              <a href="<?php echo filter_var($settings['url']); ?>account/settings" class="nav-link text-body font-weight-bold px-0">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <li class="nav-item d-flex align-items-center">
              <a href="<?php echo filter_var($settings['url']); ?>logout" class="nav-link text-body font-weight-bold px-0">
