                ...
                <div class="modal-content bg-secondary">
                    <div class="modal-body">
                        ...
                        <div class="list-group settings_menu">
                            ...
                            <?php if ($m["merchants"] == "1") { ?><?php if(idinfo($_SESSION['pw_uid'],"account_type") == "2") { ?><a href="<?= $settings['url']; ?>account/settings/business" class="list-group-item list-group-item-action <?php if($c == "business") { echo 'active'; } ?>">Business Application</a><?php } ?> <?php } ?>
                            ...
                            <?php if(idinfo($_SESSION['pw_uid'],"account_type") == "2") { ?><a href="<?= $settings['url']; ?>account/settings/api_key" class="list-group-item list-group-item-action <?php if($c == "api_key") { echo 'active'; } ?>"><?php echo filter_var($lang['settings_merchant_api_key'], FILTER_SANITIZE_STRING); ?></a><?php } ?>
