                            ...
                            <tr>
                              ...
                              <td>
                                <div class="avatar-group mt-2 text-xs">
                                  <a href="<?php echo filter_var($settings['url'], FILTER_SANITIZE_STRING); ?>account/dispute/<?php echo filter_var($row['hash'], FILTER_SANITIZE_STRING); ?>" class="btn btn-primary text-xs">View</a>
                                </div>
                              </td>
                            </tr>
                    <?php
