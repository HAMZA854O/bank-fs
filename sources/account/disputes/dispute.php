                                ...
                                <div class="modal-content">
                                    <div class="modal-body">
                                        <div class="user-connected-form-block">
                                            ...
                                            <?php if($row['status'] == "1") { ?>
                                            <a class="btn btn-secondary" href="<?php echo filter_var($settings['url'], FILTER_SANITIZE_STRING); ?>account/escalate/dispute/<?php echo filter_var($row['hash'], FILTER_SANITIZE_STRING); ?>"><?php $btn_4 = str_ireplace("%name%",$settings['name'],$lang['btn_4']); echo filter_var($btn_4, FILTER_SANITIZE_STRING); ?></a><br/>
                                            <?php } ?>
                                            <?php if($_SESSION['pw_uid'] == $row['sender']) { ?>
                                            <a class="btn btn-danger" href="<?php echo filter_var($settings['url'], FILTER_SANITIZE_STRING); ?>account/close/dispute/<?php echo filter_var($row['hash'], FILTER_SANITIZE_STRING); ?>"><?php echo filter_var($lang['btn_5'], FILTER_SANITIZE_STRING); ?></a><br/>
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="user-connected-form-block">
                            ...
                            <a href="<?php echo filter_var($settings['url'], FILTER_SANITIZE_STRING); ?>account/transaction/<?php echo filter_var($row['txid'], FILTER_SANITIZE_STRING); ?>"><?php echo filter_var($row['txid'], FILTER_SANITIZE_STRING); ?></a><br/><br/>
