            ...
            <div class="modal-body">
                <div class="user-connected-form-block">
                    ...
                    <form class="user-connected-from user-login-form" action="" method="POST">
                        ...
                        <button type="submit" name="pw_close" value="yes" class="btn btn-success"><?php echo $lang['btn_1']; ?></button> <a href="<?php echo $settings['url']; ?>account/support/<?php echo $row['hash']; ?>" class="btn btn-danger"><?php echo $lang['btn_2']; ?></a>
                    </form>
                    <?php
                    }
                    ?>
