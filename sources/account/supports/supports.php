          ...
          <div class="card mb-4">
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                      ...
                      <?php
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <?php if($row['status']<2) { ?>
                                    <a href="<?php echo $settings['url']; ?>account/support/<?php echo $row['hash']; ?>" class="btn btn-primary"><?php echo $lang['btn_6']; ?></a>
                                    <?php } else { ?>
                                    <a href="<?php echo $settings['url']; ?>account/support/<?php echo $row['hash']; ?>" class="btn btn-primary"><?php echo $lang['btn_7']; ?></a>
                                    <?php } ?>
                                </td>
                            </tr>
                    <?php
                ...
                <?php
                $ver = $settings['url']."account/supports";
              ...
              <br>
              <a href="<?php echo $settings['url']; ?>account/open/support/"><button type="button" class="btn btn-info" style="margin-left: 40%;width: 150px;">Contact us</button></a>
            </div>
          </div>
        </div>
    </div>
