                        ...
                        <div class="col-4 text-end">
                            ...
                            <div class="dropdown pe-2">
                                ...
                                <ul class="dropdown-menu px-2 py-3 ms-sm-n4 ms-n5" aria-labelledby="dropdownTable">
                                    <?php if ($m["deposit"] == 1) { ?>
                                        <li><a class="dropdown-item border-radius-md text-success" href="<?= $settings['url']; ?>account/money/deposit"><i class="fa fa-plus-circle"></i>&nbsp;&nbsp;Deposit Fund</a></li>
                                    <?php } ?>
                                    <?php if ($m["withdrawal"] == 1) { ?>
                                        <li><a class="dropdown-item border-radius-md text-info" href="<?= $settings['url']; ?>account/money/withdrawal"><i class="fa fa-minus-circle"></i>&nbsp;&nbsp;Withdraw Fund</a></li>
                                    <?php } ?>
                                </ul>
                            </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="avatar-group mt-2 text-xs">
                          <a href="<?php echo filter_var($settings['url'], FILTER_SANITIZE_STRING); ?>account/transaction/<?php echo filter_var($gua['txid'], FILTER_SANITIZE_STRING) ?>" class="btn btn-primary text-xs">View</a>
                        </div>
                      </td>
                   </tr>
