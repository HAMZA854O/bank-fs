...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3 bg-white" id="sidenav-main">
    ...
    <div >
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  <?php if($c == "send") { echo 'active'; } ?>" href="<?= $settings['url']; ?>account/money/send">
        ...
        <li class="nav-item">
          <a class="nav-link  <?php if($c == "request") { echo 'active'; } ?>" href="<?= $settings['url']; ?>account/money/request">
        ...
        <!--
        <li class="nav-item">
          <a class="nav-link  <?php if($c == "card") { echo 'active'; } ?>" href="<?= $settings['url']; ?>account/prepaid_card/card">
        ...
        <li class="nav-item">
          <a class="nav-link  <?php if($c == "converter") { echo 'active'; } ?>" href="<?= $settings['url']; ?>account/money/converter">
        ...
        ?>
        <li class="nav-item">
          <a class="nav-link  <?php if($c == "evoucher") { echo 'active'; } ?>" href="<?= $settings['url']; ?>account/money/evoucher">
        ...
        <li class="nav-item">
          <a class="nav-link  <?php if($c == "link") { echo 'active'; } ?>" href="<?= $settings['url']; ?>account/money/link">
        ...
        <?php if ($m['escrow'] == 1) { ?>
        <li class="nav-item">
          <a class="nav-link  <?php if($b == "escrow") { echo 'active'; } ?>" href="<?= $settings['url']; ?>account/escrow/open">
        ...
        <li class="nav-item">
          <a class="nav-link  <?php if($c == "fixed_deposit") { echo 'active'; } ?>" href="<?= $settings['url']; ?>account/money/fixed_deposit">
        ...
        <li class="nav-item">
          <a class="nav-link  <?php if($b == "ref") { echo 'active'; } ?>" href="<?php echo filter_var($settings['url']); ?>account/ref">
