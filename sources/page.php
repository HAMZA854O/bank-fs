			...
			<div class="col-md-9" align="right">
				<ul class="mainUl">
					...
					<li><a href="<?= $settings['url']; ?>#contact" class="main-link"><?= $lang['title_contacts'] ?></a></li>
						<?php if(!checkSession()) { ?>
                        <li><a href="<?= $settings['url']; ?>login" class="main-link logBtn"><?= $lang['menu_login'] ?></a></li>
					    <li><a href="<?= $settings['url']; ?>login" class="main-link logBtn"><?= $lang['menu_register'] ?></a></li>
                    <?php } ?>
					<?php if(checkSession()) { ?>
                        <li><a href="<?= $settings['url']; ?>account/summary" class="main-link logBtn"><?= $lang['title_summary'] ?></a></li>
    					<li><a href="<?= $settings['url']; ?>logout" class="main-link logBtn"><?= $lang['log_out'] ?></a></li>
                    <?php } ?>
				</ul>
			</div>
		</div>
