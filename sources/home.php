	...
	<div class="container">
		<div class="row">
			<div class="col-lg-6 col-lg-offset-3 tac" align="center">
				...
				<div class="flexImp">
					<a href="<?= $settings['url']; ?>account/money/send" class="cwhite td inline btnSlider fs18 fw3 inFlex ai">
					...
					<a href="<?= $settings['url']; ?>account/money/request" class="cwhite td inline btnSlider fs18 fw3 inFlex ai">
